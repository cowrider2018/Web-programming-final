...
<body>
			...
			<input type="hidden" name="email" value="<%= email %>">
				...
				<div class="cart-container" id="cart-container">
					...
					<div class="cart-item">
						...
						<span class="item-spec"><%= item.get("specName") %></span>
				...
				<form action="order.jsp" method="post">
					<div class="cart-summary">
						...
						<div id="creditCardInput" style="display: none;">
							<input type="text" name="creditCard" placeholder="信用卡號">
						</div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
			...
			var creditCardField = creditCardInput.querySelector('input[name="creditCard"]');
			
			// 初始化頁面時根據選中的付款方式設置顯示和隱藏信用卡輸入框
			if (selectedPayment === "credit-card") {
				creditCardInput.style.display = "block";
				creditCardField.setAttribute("required", "required");
			} else {
				creditCardInput.style.display = "none";
				creditCardField.removeAttribute("required");
			}
