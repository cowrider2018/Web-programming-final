...
if ("POST".equalsIgnoreCase(request.getMethod()) && "signIn".equals(request.getParameter("formId"))) {
    try {
        ...
        if (rs.next()) {
            ...
            // 如果Email不存在則註冊
            String insertSql = "INSERT INTO Member (email, password, memberName, phoneNumber, address, lastLoginTime,birth) VALUES (?,  ?, ?, ?, ?, ?, ?)";
            stmt = con.prepareStatement(insertSql, Statement.RETURN_GENERATED_KEYS);
            stmt.setString(1, email);
            stmt.setString(2, request.getParameter("password"));
            stmt.setString(3, request.getParameter("name"));
            stmt.setString(4, request.getParameter("phonenumber"));
            stmt.setString(5, request.getParameter("address"));
            stmt.setTimestamp(6, Timestamp.from(Instant.now()));
			stmt.setString(7, request.getParameter("birth"));
            stmt.executeUpdate();
    ...
    <header>
        <div class="flex">
            ...
            <div class="flex1">
				...
				<h3 class="sub"><a href="us.html" class="item">ABOUT US</a></h3>
                <div class="dropdown">
