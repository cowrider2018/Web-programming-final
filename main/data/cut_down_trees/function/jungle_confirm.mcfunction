...
execute as @e[tag=leaf] at @s run execute unless block ~ ~1 ~ minecraft:jungle_leaves run kill @e[tag=log]

execute as @e[tag=leaf] at @s run execute if block ~ ~1 ~ minecraft:jungle_leaves run function cut_down_trees:jungle_destroy
