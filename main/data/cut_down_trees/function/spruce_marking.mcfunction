execute at @e[tag=log] run execute if block ~1 ~-1 ~ minecraft:spruce_log run summon armor_stand ~1 ~-1 ~ {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~1 ~-1 ~1 minecraft:spruce_log run summon armor_stand ~1 ~-1 ~1 {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~1 ~-1 ~-1 minecraft:spruce_log run summon armor_stand ~1 ~-1 ~-1 {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~ ~-1 ~ minecraft:spruce_log run summon armor_stand ~ ~-1 ~ {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~ ~-1 ~1 minecraft:spruce_log run summon armor_stand ~ ~-1 ~1 {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~ ~-1 ~-1 minecraft:spruce_log run summon armor_stand ~ ~-1 ~-1 {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~-1 ~-1 ~ minecraft:spruce_log run summon armor_stand ~-1 ~-1 ~ {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
execute at @e[tag=log] run execute if block ~-1 ~-1 ~1 minecraft:spruce_log run summon armor_stand ~-1 ~-1 ~1 {Tags:["check"],Small:1,NoGravity:1,Invisible:1}
