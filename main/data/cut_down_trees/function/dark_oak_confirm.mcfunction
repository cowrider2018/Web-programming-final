...
execute as @e[tag=leaf] at @s run execute unless block ~ ~1 ~ minecraft:dark_oak_leaves run kill @e[tag=log]

execute as @e[tag=leaf] at @s run execute if block ~ ~1 ~ minecraft:dark_oak_leaves run function cut_down_trees:dark_oak_destroy
