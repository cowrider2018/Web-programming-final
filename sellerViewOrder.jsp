...
<body>
    ...
    <div>
        ...
        <table border=1>
            ...
            <%
            // 查詢當前訂單的詳細信息
            String queryDetails = "SELECT od.itemId, i.itemName, i.itemDescription, i.price, od.quantity FROM OrderDetails od JOIN Item i ON od.itemId = i.itemId WHERE od.orderId = ?";
            ...
            <tr>
                ...
                <td><%= rsDetails.getString("itemDescription") %></td>
